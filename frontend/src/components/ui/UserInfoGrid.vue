                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="LoginPw">{{ val.loginPw }}</td>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <String label="LoginPw" v-model="selectedRow.loginPw" :editMode="true"/>
    ...
    methods:{
        async buyPlan(params){
            try{
                ...
                // 스넥바 관련 수정 필요
                // this.$EventBus.$emit('show-success','buyPlan 성공적으로 처리되었습니다.')
