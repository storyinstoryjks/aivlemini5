<template>
    <v-container>
        ...
        <div class="panel">
            ...
            <ReadAllBooks @search="search" style="margin-bottom: 10px; background-color: #ffffff;"></ReadAllBooks>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <String label="StatusMessage" v-model="selectedRow.statusMessage" :editMode="true"/>
